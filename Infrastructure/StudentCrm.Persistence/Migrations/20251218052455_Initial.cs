        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Terms_StartBeforeEnd", "[StartDate] < [EndDate]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalGrade = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Enrollments_TotalGrade_Range", "[TotalGrade] IS NULL OR ([TotalGrade] >= 0 AND [TotalGrade] <= 100)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sections_CourseId_TermId_SectionCode",
                table: "Sections",
